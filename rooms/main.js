...
//https://stackoverflow.com/questions/6701705/programmatically-creating-an-svg-image-element-with-javascript
    ...
    var banner = document.getElementById("myCanvas")
...
//    img.src = "data:image/svg+xml;base64," + btoa(svg_xml)
 //   ctx.drawImage(img, 0 , 0 , 100, 100);
    ...
    function continueStory(firstTime) {
        ...
        console.log("continue======", firstTime)
        console.log("pre text", story.currentText)
        console.log("can", story.canContinue)
        ...
        console.log("tags", story.currentTags)
        console.log("post text", story.currentText)
        console.log("choices", story.currentChoices)
